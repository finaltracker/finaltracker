...
//			}
		...
		// r.inset(-dx, -dy);
		if (((GROW_LEFT_EDGE | GROW_RIGHT_EDGE) & edge) != 0) { // 左右边
			r.set(r.left - dx, r.top, r.right + dx, r.bottom);
		} else if (((GROW_TOP_EDGE | GROW_BOTTOM_EDGE) & edge) != 0) { // 上下边
			r.set(r.left, r.top - dy, r.right, r.bottom + dy);
		}
